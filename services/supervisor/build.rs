...
fn main() {
    ...
    const EMBEDDED: &[&str] = &["pong", "roster", "reply-server", "holder", "upper", "mem-pressure", "ping", "time", "logger", "asker", "resource-server", "chaos", "control", "observe", "greet", "counter", "shell"];
