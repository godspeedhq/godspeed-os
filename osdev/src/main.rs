...
pub fn cmd_build() {
    ...
    let service_crates = [
        "supervisor", "logger", "mem-hog", "ping", "pong", "greet", "upper", "roster", "probe", "observe", "shell", "xhci", "ehci", "block-driver", "fs",
    ];
...
pub fn cmd_build_bare_metal() {
    clean_supervisor();
    let non_supervisor = ["logger", "mem-hog", "ping", "pong", "greet", "upper", "roster", "probe", "observe", "shell", "xhci", "ehci", "block-driver", "fs"];
