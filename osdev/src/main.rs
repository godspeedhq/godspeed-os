...
pub fn cmd_build() {
    ...
    let service_crates = [
        "supervisor", "logger", "mem-pressure", "chaos", "ping", "pong", "greet", "upper", "roster", "probe", "observe", "shell", "xhci", "ehci", "block-driver", "nic-driver", "fs", "counter", "reply-server", "asker", "resource-server", "holder",
    ];
...
pub fn cmd_build_bare_metal() {
    clean_supervisor();
    let non_supervisor = ["logger", "mem-pressure", "chaos", "ping", "pong", "greet", "upper", "roster", "probe", "observe", "shell", "xhci", "ehci", "block-driver", "nic-driver", "fs", "counter", "reply-server", "asker", "resource-server", "holder"];
...
fn build_blockdev_fs(fs_features: &str, bd_features: &str) {
    ...
    let non_supervisor = ["logger", "ping", "pong", "greet", "upper", "roster", "probe", "observe", "shell", "xhci", "ehci", "block-driver", "nic-driver", "counter", "reply-server", "asker", "resource-server", "holder"];
    for crate_name in &non_supervisor {
