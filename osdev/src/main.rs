...
pub fn cmd_build() {
    ...
    let service_crates = [
        "init", "supervisor", "logger", "ping", "pong", "greet", "upper", "roster", "probe", "observe", "shell", "xhci", "ehci", "block-driver", "fs",
    ];
...
pub fn cmd_build_bare_metal() {
    clean_supervisor();
    let non_supervisor = ["init", "logger", "ping", "pong", "greet", "upper", "roster", "probe", "observe", "shell", "xhci", "ehci", "block-driver", "fs"];
...
fn build_blockdev_fs(fs_features: &str, bd_features: &str) {
    ...
    let non_supervisor = ["init", "logger", "ping", "pong", "greet", "upper", "roster", "probe", "observe", "shell", "xhci", "ehci", "block-driver"];
    for crate_name in &non_supervisor {
