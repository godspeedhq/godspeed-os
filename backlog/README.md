...
| [42](42-the-pi2-stick-accepted-the-flush-6-1-says-it-refuses.md) | the Pi 2's stick ACCEPTED `SYNCHRONIZE CACHE` on 2026-09-22 and recovered a deterministic cut in the strong form, while `CLAUDE.md` 6.1 records it as refusing. The only local evidence for the refusal is a warning that fired when the DRIVER was dead, not the device - now fixed to tell those apart | Recorded (26.7) | more mounts before a constitutional claim moves |
